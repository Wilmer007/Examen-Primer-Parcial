...
public static class SistemaDeAtencionAlClienteEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE SistemaDeAtencionAlClienteModuleExtensionConfigurator CLASS (in the Domain.Shared project)
