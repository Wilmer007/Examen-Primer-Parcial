...
namespace SistemaDeAtencionAlCliente.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("SistemaDeAtencionAlCliente") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "SistemaDeAtencionAlCliente", DisplayName = "SistemaDeAtencionAlCliente API", Resources = { "SistemaDeAtencionAlCliente" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["SistemaDeAtencionAlCliente_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["SistemaDeAtencionAlCliente_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["SistemaDeAtencionAlCliente_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["SistemaDeAtencionAlCliente_Swagger:RootUrl"]?.TrimEnd('/');
